/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example --strict-vars=false` (hash: f19dafa17761ebfbafe66b463b2dc65f)
// Runtime types generated with workerd@1.20260730.1 2026-08-02 nodejs_compat
interface __BaseEnv_Env {
	AXORA_EMAIL_EVENTS_ENDPOINT_URL: string;
	AXORA_EMAIL_EVENTS_EXPECTED_DOMAIN: string;
	AXORA_EMAIL_EVENTS_WEBHOOK_SECRET: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AXORA_EMAIL_EVENTS_ENDPOINT_URL" | "AXORA_EMAIL_EVENTS_EXPECTED_DOMAIN" | "AXORA_EMAIL_EVENTS_WEBHOOK_SECRET">> {}
}
