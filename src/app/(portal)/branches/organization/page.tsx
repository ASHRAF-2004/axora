...
export default async function OrganizationPage({
  ...
  return <>
    ...
    {(workspace.canManageDepartments || workspace.canManageCostCentres || workspace.canManageDeliveryLocations) ? <DeferredOrganizationActions label={copy.update}><section className="detail-grid">
