...
export default async function OrganizationPage({
  ...
  return <>
    ...
    {(workspace.canManageDepartments || workspace.canManageCostCentres || workspace.canManageDeliveryLocations) ? <section className="detail-grid">
