...
import { BookOpenCheck, CircleHelp, ClipboardPlus, LayoutDashboard, PackageSearch, ShieldCheck } from "lucide-react";

export default function HelpPage() {
  return <><PageHeader eyebrow="User guide" title="How to use Axora" description="A simple path for managing procurement and daily operations." />
    <section className="dashboard-grid"><article className="panel"><div className="panel-header"><div><h2>Daily user workflow</h2><p>Follow these steps in order</p></div></div><div className="panel-body readiness-list">
    ...
    </div></article><article className="panel"><div className="panel-header"><div><h2>Important rules</h2><p>Keep company data accurate and secure</p></div></div><div className="panel-body readiness-list">
      ...
      <div className="readiness-item"><ShieldCheck /><div><strong>Respect company boundaries</strong><p>Use only your assigned company workspace and never share account credentials.</p></div></div>
    </div></article></section>
  </>;
}
