...
export default async function DocumentsPage() {
  ...
  return <><PageHeader eyebrow="Evidence storage" title="Documents" description="Attach small quotation, invoice, delivery, or supporting files to an existing record. Files remain on the internal server." />
    <section className="detail-grid"><article className="panel form-panel"><h2>Upload a document</h2><form action={uploadAttachmentAction}><div className="form-grid">
      ...
      <aside className="panel"><div className="panel-header"><div><h2>Safety limits</h2><p>Simple rules for the pilot</p></div><FileCheck2 /></div><div className="panel-body"><div className="callout"><strong>Maximum 2 MB per file.</strong><p>Allowed: PDF, PNG, JPG, TXT, and CSV. Do not upload passwords, executable files, or unrelated personal data.</p></div></div></aside>
