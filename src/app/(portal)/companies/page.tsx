...
export default async function CompaniesPage() {
  ...
  return <><PageHeader eyebrow="Axora master data" title="Customer companies" description="Axora owners approve each customer company before its branches, users and purchase requests can be managed." />
    ...
    </div><div className="form-actions"><button className="button button-primary" type="submit">Register company</button></div></form></section></>;
}
