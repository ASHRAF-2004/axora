    ...
    <section className="split-layout">
      ...
      <form action={createProductAction} className="panel form-panel">
        ...
        <div className="form-grid">
          ...
          <label>{copy.sellPrice}<input name="defaultSellPrice" type="number" min="0.01" step="0.01" required /></label>
          <label>{copy.minimumOrder}<input name="minimumOrderQuantity" type="number" min="1" step="1" defaultValue="1" required />
            <small>{copy.minimumOrderHelp}</small></label>
