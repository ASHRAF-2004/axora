...
const eventLabels = {
  en: {
    ...
    "driver.assigned": "Delivery Agent assigned",
  ...
  ar: {
    ...
    "delivery.updated": "تم تحديث التسليم",
    "driver.assigned": "تم إسناد مسؤول التوصيل",
  ...
  ms: {
    ...
    "delivery.updated": "Penghantaran dikemas kini",
    "driver.assigned": "Ejen Penghantaran ditugaskan",
