...
export const ADDITIVE_PERMISSION_CATALOG = [
  ...
  { "code": "delivery.tracking.history", "group": "Delivery", "label": "View delivery tracking history", "description": "View authorized delivery tracking history and route evidence.", "highRisk": true },
