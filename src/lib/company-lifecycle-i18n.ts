...
const en = {
  ...
  count: "{count} companies", allStatuses: "All statuses", filter: "Filter", noCompanies: "No companies match your search.",
...
const ar: Copy = {
  ...
  count: "{count} شركة", allStatuses: "كل الحالات", filter: "تصفية", noCompanies: "لا توجد شركات مطابقة للبحث.",
...
const ms: Copy = {
  ...
  count: "{count} syarikat", allStatuses: "Semua status", filter: "Tapis", noCompanies: "Tiada syarikat sepadan dengan carian.",
