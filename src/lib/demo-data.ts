...
const branches: Branch[] = [
  ...
  { id: "88888888-8888-4888-8888-888888888888", code: "B-E2E", companyId: "11111111-1111-4111-8111-111111111111", companyName: "Axora E2E Company", name: "Authorized E2E branch", branchCode: "E2E-MAIN", deliveryAddress: "Demo mode only", city: "Kuala Lumpur", contactName: "Authorized fixture", contactPhone: "000-000-0000", contactEmail: "admin@axora.example", deliveryInstructions: "Demo mode only.", monthlyBudget: 5000, committedAmount: 0, remainingAmount: 5000, status: "Active" },
];
