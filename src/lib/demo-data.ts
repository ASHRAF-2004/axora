...
const companies: Company[] = [
  ...
  { id: "11111111-1111-4111-8111-111111111111", code: "C-E2E", name: "Axora E2E Company", industry: "Testing", mainContactName: "Authorized fixture", mainContactEmail: "admin@axora.example", mainContactPhone: "000-000-0000", billingContactName: "Authorized fixture", billingContactEmail: "billing@axora.example", billingContactPhone: "000-000-0000", billingAddress: "Demo mode only", paymentTerms: STANDARD_BILLING_TERMS, billingCycle: "Monthly", taxRate: 0, estimatedDeliveryFee: 0, status: "Active" },
];

const branches: Branch[] = [
  { id: "br-youruni-main", code: "B-001", companyId: "co-youruni", companyName: "YourUni", name: "YourUni main campus", branchCode: "YU-MAIN", deliveryAddress: "Kuala Lumpur", city: "Kuala Lumpur", contactName: "Campus reception", contactPhone: "+12025550110", contactEmail: "reception@youruni.example", deliveryInstructions: "Call reception before delivery.", monthlyBudget: 5000, committedAmount: 1540, remainingAmount: 3460, status: "Active" },
  { id: "br-excel-hq", code: "B-002", companyId: "co-excel", companyName: "Excel Language Centre", name: "Excel HQ", branchCode: "EX-HQ", deliveryAddress: "Petaling Jaya", city: "Petaling Jaya", contactName: "HQ reception", contactPhone: "+12025550111", contactEmail: "reception@excel.example", monthlyBudget: 4000, committedAmount: 830, remainingAmount: 3170, status: "Active" },
  { id: "br-unibax-centre", code: "B-003", companyId: "co-unibax", companyName: "Unibax", name: "Unibax centre", branchCode: "UB-CEN", deliveryAddress: "Shah Alam", city: "Shah Alam", contactName: "Centre reception", contactPhone: "+12025550112", contactEmail: "reception@unibax.example", monthlyBudget: 3500, committedAmount: 620, remainingAmount: 2880, status: "Active" },
  { id: "88888888-8888-4888-8888-888888888888", code: "B-E2E", companyId: "11111111-1111-4111-8111-111111111111", companyName: "Axora E2E Company", name: "Authorized E2E branch", branchCode: "E2E-MAIN", deliveryAddress: "Demo mode only", city: "Kuala Lumpur", contactName: "Authorized fixture", contactPhone: "+12025550113", contactEmail: "admin@axora.example", deliveryInstructions: "Demo mode only.", monthlyBudget: 5000, committedAmount: 0, remainingAmount: 5000, status: "Active" },
];
...
const scenarios: Array<Omit<ProcurementRequest, "id" | "orderCode" | "requestDate" | "lines" | "approvalStatus" | "estimatedTotal"> & { products: Array<[number, number, Partial<ProcurementRequest["lines"][number]>?]> }> = [
  ...
  { requestType: "Standard", companyId: "11111111-1111-4111-8111-111111111111", companyName: "Axora E2E Company", branchId: "88888888-8888-4888-8888-888888888888", branchName: "Authorized E2E branch", department: "Operations", requestedBy: "Company administrator fixture", requesterContact: "+12025550113", neededByDate: "2026-08-09", urgency: "Normal", status: "Out for Delivery", invoiceStatus: "Not Issued", paymentStatus: "Unpaid", products: [[0, 1, { deliveryStatus: "Out for Delivery", expectedDeliveryDate: "2026-08-09" }]] },
];
