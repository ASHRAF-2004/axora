...
"approval.check_information", "approval.approved", "approval.rejected",
...
const messages: Record<SupportedLocale, Record<ActionFeedbackCode, string>> = {
  en: {
"approval.check_information": "Check the approval information and try again.", "approval.approved": "Purchase request approved.", "approval.rejected": "Purchase request rejected.", "approval.decision_failed": "The decision could not be saved. Please try again. If the problem continues, contact an administrator.", "approval.choice_required": "Choose Approve or Reject.", "approval.not_assigned": "Only an assigned company approver can decide this request.", "approval.request_not_found": "Request not found.", "approval.branch_inactive": "This branch is inactive and cannot approve new spending.", "approval.not_pending": "This request is not pending approval for your branch.", "approval.self_approval": "You cannot approve your own purchase request.", "approval.final_decision": "This purchase request already has a final company decision.", "approval.over_budget": "This request exceeds the branch's available monthly budget.",
  },
  ar: {
"approval.check_information": "تحقق من معلومات الاعتماد وحاول مرة أخرى.", "approval.approved": "تم اعتماد طلب الشراء.", "approval.rejected": "تم رفض طلب الشراء.", "approval.decision_failed": "تعذر حفظ القرار. حاول مرة أخرى، وإذا استمرت المشكلة فتواصل مع المدير.", "approval.choice_required": "اختر الاعتماد أو الرفض.", "approval.not_assigned": "لا يقرر هذا الطلب إلا معتمد معين من الشركة.", "approval.request_not_found": "لم يتم العثور على الطلب.", "approval.branch_inactive": "هذا الفرع غير نشط ولا يمكنه اعتماد إنفاق جديد.", "approval.not_pending": "هذا الطلب ليس بانتظار الاعتماد لفرعك.", "approval.self_approval": "لا يمكنك اعتماد طلب الشراء الخاص بك.", "approval.final_decision": "لدى طلب الشراء هذا قرار نهائي من الشركة بالفعل.", "approval.over_budget": "يتجاوز هذا الطلب الميزانية الشهرية المتاحة للفرع.",
  },
  ms: {
"approval.check_information": "Semak maklumat kelulusan dan cuba lagi.", "approval.approved": "Permintaan pembelian diluluskan.", "approval.rejected": "Permintaan pembelian ditolak.", "approval.decision_failed": "Keputusan tidak dapat disimpan. Cuba lagi. Jika masalah berterusan, hubungi pentadbir.", "approval.choice_required": "Pilih Luluskan atau Tolak.", "approval.not_assigned": "Hanya pelulus syarikat yang ditugaskan boleh memutuskan permintaan ini.", "approval.request_not_found": "Permintaan tidak ditemui.", "approval.branch_inactive": "Cawangan ini tidak aktif dan tidak boleh meluluskan perbelanjaan baharu.", "approval.not_pending": "Permintaan ini tidak menunggu kelulusan untuk cawangan anda.", "approval.self_approval": "Anda tidak boleh meluluskan permintaan pembelian sendiri.", "approval.final_decision": "Permintaan pembelian ini sudah mempunyai keputusan akhir syarikat.", "approval.over_budget": "Permintaan ini melebihi bajet bulanan cawangan yang tersedia.",
  },
};

const approvalErrorCodes = new Map<string, ActionFeedbackCode>([
["Choose Approve or Reject.", "approval.choice_required"],
