...
const english: RolePortalMessages = {
  ...
  supplier: {
    ...
    invoiceTitle: "Supplier invoices and COD status", invoiceIntro: "Only invoices registered by Axora finance for your supplier organization appear here.",
...
const arabic: RolePortalMessages = {
  ...
  supplier: {
    ...
    invoiceTitle: "فواتير المورد وحالة الدفع عند الاستلام", invoiceIntro: "تظهر هنا فقط الفواتير التي سجلها فريق مالية أكسورا لمؤسستك.",
...
const malay: RolePortalMessages = {
  ...
  supplier: {
    ...
    invoiceTitle: "Invois pembekal dan status COD", invoiceIntro: "Hanya invois yang didaftarkan oleh kewangan Axora untuk organisasi pembekal anda dipaparkan.",
