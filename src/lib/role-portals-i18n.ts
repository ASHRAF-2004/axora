...
const english: RolePortalMessages = {
  ...
  driver: {
    eyebrow: "Delivery Agent workspace", title: "Assigned deliveries",
    ...
    evidenceOnly: "This is Delivery Agent-reported evidence only. The customer receiver confirms acceptance separately.",
    ...
    addNote: "Add Delivery Agent note", operationalNote: "Operational note", saveNoteOffline: "Save note offline",
    uploadEvidence: "Upload Delivery Agent evidence", photoOrDeliveryNote: "Photo or delivery note",
    syncBeforeEvidence: "Sync the latest status before attaching evidence to it.",
    evidenceHint: "Maximum 5 MB. Evidence supports the Delivery Agent timeline; the receiver confirms quantities separately.",
    uploadEvidenceButton: "Upload evidence",
  },
  receiving: {
    eyebrow: "Customer receiving", title: "Confirm delivered quantities",
    description: "Inspect every line independently. Delivery Agent photos and delivery notes are supporting evidence, not customer acceptance.",
    receiptConfirmedNotice: "Receipt confirmed and recorded independently from Delivery Agent evidence.",
    ...
    emptyBody: "A job appears here only after its assigned Delivery Agent records delivery.",
    awaitingDriverEvent: "Awaiting Delivery Agent delivery event", driverRecorded: "Delivery Agent recorded:",
    driverReportedReceiver: "Delivery Agent-reported handover name", driverEvidenceOnly: "Supporting Delivery Agent evidence only — it is not customer acceptance.",
    driverReportedQuantity: "Delivery Agent reported", missing: "missing", confirmingAs: (name) => `You are confirming as ${name}.`,
    ...
    confirmationExplanation: "By confirming, you create the customer receipt. This does not alter the Delivery Agent’s evidence.",
...
const arabic: RolePortalMessages = {
  ...
  driver: {
    eyebrow: "مساحة عمل مسؤول التوصيل", title: "عمليات التسليم المسندة",
    ...
    evidenceOnly: "هذا دليل سجله مسؤول التوصيل فقط. يؤكد مستلم العميل القبول بصورة مستقلة.",
    ...
    addNote: "إضافة ملاحظة لمسؤول التوصيل", operationalNote: "ملاحظة تشغيلية", saveNoteOffline: "حفظ الملاحظة دون اتصال",
    ...
    evidenceHint: "الحد الأقصى 5 ميجابايت. يدعم الدليل سجل مسؤول التوصيل، ويؤكد المستلم الكميات بشكل منفصل.",
    uploadEvidenceButton: "رفع الدليل",
  },
  receiving: {
    eyebrow: "استلام العميل", title: "تأكيد الكميات المسلمة",
    description: "افحص كل بند بشكل مستقل. صور مسؤول التوصيل وسندات التسليم أدلة مساندة وليست قبولًا من العميل.",
    receiptConfirmedNotice: "تم تأكيد الاستلام وتسجيله بشكل مستقل عن دليل مسؤول التوصيل.",
    ...
    emptyBody: "تظهر المهمة هنا فقط بعد أن يسجل مسؤول التوصيل عملية التسليم.",
    awaitingDriverEvent: "بانتظار تسجيل مسؤول التوصيل للتسليم", driverRecorded: "سجل مسؤول التوصيل:",
    driverReportedReceiver: "اسم التسليم الذي سجله مسؤول التوصيل", driverEvidenceOnly: "دليل مسؤول التوصيل مساند فقط — وليس قبولًا من العميل.",
    driverReportedQuantity: "ما سجله مسؤول التوصيل", missing: "مفقود", confirmingAs: (name) => `أنت تؤكد الاستلام باسم ${name}.`,
    ...
    confirmationExplanation: "عند التأكيد، تنشئ سجل استلام العميل. لا يغير ذلك دليل مسؤول التوصيل.",
...
const malay: RolePortalMessages = {
  ...
  driver: {
    eyebrow: "Ruang kerja Ejen Penghantaran", title: "Penghantaran ditugaskan",
    ...
    evidenceOnly: "Ini hanya bukti yang dilaporkan Ejen Penghantaran. Penerima pelanggan mengesahkan penerimaan secara berasingan.",
    ...
    addNote: "Tambah nota Ejen Penghantaran", operationalNote: "Nota operasi", saveNoteOffline: "Simpan nota luar talian",
    uploadEvidence: "Muat naik bukti Ejen Penghantaran", photoOrDeliveryNote: "Foto atau nota penghantaran",
    syncBeforeEvidence: "Segerakkan status terkini sebelum melampirkan bukti kepadanya.",
    evidenceHint: "Maksimum 5 MB. Bukti menyokong garis masa Ejen Penghantaran; penerima mengesahkan kuantiti secara berasingan.",
    uploadEvidenceButton: "Muat naik bukti",
  },
  receiving: {
    eyebrow: "Penerimaan pelanggan", title: "Sahkan kuantiti dihantar",
    description: "Periksa setiap baris secara berasingan. Foto Ejen Penghantaran dan nota penghantaran ialah bukti sokongan, bukan penerimaan pelanggan.",
    receiptConfirmedNotice: "Penerimaan disahkan dan direkodkan secara berasingan daripada bukti Ejen Penghantaran.",
    ...
    emptyBody: "Kerja hanya dipaparkan di sini selepas Ejen Penghantaran yang ditugaskan merekodkan penghantaran.",
    awaitingDriverEvent: "Menunggu peristiwa penghantaran Ejen Penghantaran", driverRecorded: "Ejen Penghantaran merekodkan:",
    driverReportedReceiver: "Nama serahan dilaporkan Ejen Penghantaran", driverEvidenceOnly: "Bukti sokongan Ejen Penghantaran sahaja — bukan penerimaan pelanggan.",
    driverReportedQuantity: "Dilaporkan Ejen Penghantaran", missing: "hilang", confirmingAs: (name) => `Anda mengesahkan sebagai ${name}.`,
    ...
    confirmationExplanation: "Dengan mengesahkan, anda mencipta rekod penerimaan pelanggan. Ini tidak mengubah bukti Ejen Penghantaran.",
