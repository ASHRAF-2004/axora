...
export const DASHBOARD_METRIC_DEFINITIONS: readonly DashboardMetricDefinition[] = [
  ...
  { key: "approvedSpend", meaning: "Requested value for cohort requests with a company approval or recorded Company Admin direct-purchase decision.", source: "requests, request_lines, approvals, and direct-purchase decisions", dateField: "COALESCE(approval_submitted_at, created_at)", statuses: "Approved or direct-purchased; excludes Cancelled", currency: "MYR; no currency conversion", scope: "company", refresh: "Live at page load" },
  { key: "pendingApprovalCount", meaning: "Cohort requests currently awaiting a decision from this authorized actor.", source: "canonical approval workspace", dateField: "COALESCE(approval_submitted_at, created_at)", statuses: "Current actionable approval state and actor scope", currency: "Not applicable", scope: "company", refresh: "Live at page load" },
