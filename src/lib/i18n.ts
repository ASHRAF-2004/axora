...
const english: PublicMessages = {
  ...
  contact: { eyebrow: "Contact Us", title: "Not sure where to start?", intro: "Send us a message and tell us how Axora can help your procurement workflow.", name: "Full Name", email: "Email Address", company: "Company", phone: "Contact Number", subject: "Subject", message: "Message", privacy: "I agree to share this information with Axora as described in the", submit: "Send enquiry", sending: "Sending…", success: "Thank you. Your enquiry has been recorded and Axora will follow up.", failure: "The enquiry could not be sent. Please check the form and try again.", unavailable: "Contact submission is temporarily unavailable. Please try again later.", securityNote: "Your enquiry is rate limited, checked for automated abuse, and stored for authorized Axora follow-up. Never include passwords or invitation links.", validationNote: "Protected by Turnstile and server-side validation." },
  footer: { summary: "Secure, role-aware procurement coordination from request to verified record.", product: "Product", company: "Company", legal: "Legal", privacy: "Privacy Policy", terms: "Terms & Conditions", rights: "All rights reserved." },
  pages: englishPages,
};
...
const arabic: PublicMessages = {
  ...
  contact: { eyebrow: "تواصل معنا", title: "لست متأكدًا من أين تبدأ؟", intro: "أرسل لنا رسالة وأخبرنا كيف يمكن لأكسورا مساعدة مسار المشتريات لديك.", name: "الاسم الكامل", email: "عنوان البريد الإلكتروني", company: "الشركة", phone: "رقم التواصل", subject: "الموضوع", message: "الرسالة", privacy: "أوافق على مشاركة هذه المعلومات مع أكسورا كما هو موضح في", submit: "إرسال الاستفسار", sending: "جارٍ الإرسال…", success: "شكرًا لك. تم تسجيل الاستفسار وستتواصل معك أكسورا.", failure: "تعذر إرسال الاستفسار. تحقق من البيانات وحاول مرة أخرى.", unavailable: "خدمة التواصل غير متاحة مؤقتًا. حاول لاحقًا.", securityNote: "يخضع الاستفسار لتحديد المعدل وفحص الاستخدام الآلي، ويُحفظ لمتابعة مخوّلة من أكسورا. لا تضع كلمة مرور أو رابط دعوة.", validationNote: "محمي بواسطة Turnstile والتحقق من جانب الخادم." },
  footer: { summary: "تنسيق مشتريات آمن ومحدد الصلاحيات من الطلب إلى السجل الموثق.", product: "المنتج", company: "الشركة", legal: "قانوني", privacy: "سياسة الخصوصية", terms: "الشروط والأحكام", rights: "جميع الحقوق محفوظة." },
  pages: arabicPages,
};
...
const malay: PublicMessages = {
  ...
  contact: { eyebrow: "Hubungi Kami", title: "Tidak pasti hendak bermula dari mana?", intro: "Hantar mesej dan beritahu kami bagaimana Axora boleh membantu aliran kerja perolehan anda.", name: "Nama Penuh", email: "Alamat E-mel", company: "Syarikat", phone: "Nombor Telefon", subject: "Subjek", message: "Mesej", privacy: "Saya bersetuju untuk berkongsi maklumat ini dengan Axora seperti yang diterangkan dalam", submit: "Hantar pertanyaan", sending: "Menghantar…", success: "Terima kasih. Pertanyaan anda telah direkodkan dan Axora akan membuat susulan.", failure: "Pertanyaan tidak dapat dihantar. Semak borang dan cuba lagi.", unavailable: "Penghantaran borang tidak tersedia buat sementara waktu. Cuba lagi kemudian.", securityNote: "Pertanyaan dihadkan kadarnya, diperiksa untuk penyalahgunaan automatik dan disimpan untuk susulan Axora yang dibenarkan. Jangan masukkan kata laluan atau pautan jemputan.", validationNote: "Dilindungi oleh Turnstile dan pengesahan sebelah pelayan." },
  footer: { summary: "Penyelarasan perolehan selamat dan berasaskan peranan daripada permintaan kepada rekod disahkan.", product: "Produk", company: "Syarikat", legal: "Perundangan", privacy: "Dasar Privasi", terms: "Terma & Syarat", rights: "Hak cipta terpelihara." },
  pages: malayPages,
};
