...
export const publicVisitorCopy: Record<SupportedLocale, VisitorChoiceCopy> = {
  en: {
    ...
    body: "Choose once. Axora verifies the claim on the server and keeps your visitor number tied to an anonymous signed claim.",
    ...
    retry: "Try again",
    protectedBy: "Protected by Turnstile and Axora anti-abuse checks",
  ...
  ar: {
    ...
    body: "اختر مرة واحدة. تتحقق أكسورا من المطالبة على الخادم وتربط رقم زائرك بمطالبة مجهولة وموقعة.",
    ...
    protectedBy: "محمي بواسطة Turnstile وآليات أكسورا لمكافحة إساءة الاستخدام",
  ...
  ms: {
    ...
    body: "Pilih sekali. Axora mengesahkan tuntutan pada pelayan dan mengaitkan nombor pelawat anda dengan tuntutan tanpa nama yang ditandatangani.",
    ...
    retry: "Cuba lagi",
    protectedBy: "Dilindungi oleh Turnstile dan semakan anti-penyalahgunaan Axora",
