...
const englishNavigation: Record<string, PortalNavigationCopy> = {
  ...
  "/driver": { label: "Delivery", description: "Acquire items and complete assigned delivery proof" },
  ...
  "/branches": { label: "Branches", description: "Delivery-ready company branches" },
  ...
  "/integrations": { label: "Integrations", description: "Connected apps and external access" },
...
const english: PortalMessages = {
  roles: {
    ...
    DELIVERY_DRIVER: "Delivery Agent", DELIVERY_GUY: "Delivery Agent",
...
const arabic: PortalMessages = {
  roles: {
    ...
    DELIVERY_DRIVER: "مسؤول التوصيل", DELIVERY_GUY: "مسؤول التوصيل", RECEIVING_USER: "مستخدم الاستلام", SCOPED_USER: "مستخدم محدد النطاق",
  },
  navigation: {
    "/dashboard": { label: "لوحة التحكم" },
    "/driver": { label: "مهام مسؤول التوصيل", description: "حالات وأدلة تسليم تتحمل ضعف الاتصال" },
    ...
    "/finance": { label: "المالية" }, "/companies": { label: "الشركات", description: "تهيئة الشركات وصحتها" },
    "/branches": { label: "الفروع", description: "فروع الشركة الجاهزة للتسليم" },
    ...
    "/integrations": { label: "التكاملات", description: "التطبيقات المتصلة والوصول الخارجي" },
...
const malay: PortalMessages = {
  roles: {
    ...
    DELIVERY_DRIVER: "Ejen Penghantaran", DELIVERY_GUY: "Ejen Penghantaran", RECEIVING_USER: "Pengguna penerimaan", SCOPED_USER: "Pengguna berskop",
  },
  navigation: {
    "/dashboard": { label: "Papan pemuka" },
    "/driver": { label: "Tugasan Ejen Penghantaran", description: "Status dan bukti penghantaran selamat luar talian" },
    ...
    "/finance": { label: "Kewangan" }, "/companies": { label: "Syarikat", description: "Penerimaan masuk dan kesihatan penyewa" },
    "/branches": { label: "Cawangan", description: "Cawangan syarikat sedia penghantaran" },
    ...
    "/integrations": { label: "Integrasi", description: "Aplikasi bersambung dan akses luaran" },
