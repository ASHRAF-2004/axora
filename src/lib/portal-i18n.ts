...
const englishNavigation: Record<string, PortalNavigationCopy> = {
  ...
  "/supplier": { label: "Supplier RFQs", description: "Assigned RFQs, quotations and documents" },
  "/driver": { label: "Driver assignments", description: "Offline-safe status and delivery evidence" },
  "/receiving": { label: "Receiving", description: "Independent line-by-line receipt confirmation" },
  "/products": { label: "Shop", description: "Products and customer-facing images" },
  ...
  "/suppliers": { label: "Suppliers", description: "Private supplier organizations" },
  "/users": { label: "People & access", description: "Invitations, roles and scope" },
  "/documents": { label: "Documents", description: "Permitted evidence and records" },
...
const english: PortalMessages = {
  roles: {
    ...
    PLATFORM_OWNER: "Platform owner", PLATFORM_OPERATIONS: "Axora operations administrator",
    ...
    SUPPLIER_USER: "Supplier user", DELIVERY_DRIVER: "Delivery driver",
    RECEIVING_USER: "Receiving user", SCOPED_USER: "Scoped user",
  },
  navigation: englishNavigation,
  quickActions: { newRequest: "New request", addCompany: "Add company", openSourcing: "Open sourcing", catalog: "Catalog" },
  shell: {
...
const arabic: PortalMessages = {
  roles: {
    ...
    TECHNICAL_SUPPORT: "الدعم التقني", SUPPLIER_USER: "مستخدم المورد",
    DELIVERY_DRIVER: "سائق التسليم", RECEIVING_USER: "مستخدم الاستلام", SCOPED_USER: "مستخدم محدد النطاق",
  },
  navigation: {
    "/dashboard": { label: "لوحة التحكم" },
    "/supplier": { label: "طلبات أسعار المورد", description: "طلبات الأسعار والعروض والمستندات المسندة" },
    ...
    "/products": { label: "المتجر", description: "المنتجات والصور الظاهرة للعملاء" },
    "/requests": { label: "الطلبات" }, "/approvals": { label: "الاعتمادات" },
    "/budgets": { label: "الميزانيات", description: "دفتر التفويض والفترات والحجوزات" },
    "/sourcing": { label: "التوريد" }, "/deliveries": { label: "عمليات التسليم" },
    ...
    "/suppliers": { label: "الموردون", description: "مؤسسات الموردين الخاصة" },
    "/users": { label: "الأشخاص والصلاحيات", description: "الدعوات والأدوار والنطاق" },
    "/documents": { label: "المستندات", description: "الأدلة والسجلات المسموح بها" },
  ...
  quickActions: { newRequest: "طلب جديد", addCompany: "إضافة شركة", openSourcing: "فتح التوريد", catalog: "الكتالوج" },
  shell: {
...
const malay: PortalMessages = {
  roles: {
    ...
    TECHNICAL_SUPPORT: "Sokongan teknikal", SUPPLIER_USER: "Pengguna pembekal",
    DELIVERY_DRIVER: "Pemandu penghantaran", RECEIVING_USER: "Pengguna penerimaan", SCOPED_USER: "Pengguna berskop",
  },
  navigation: {
    "/dashboard": { label: "Papan pemuka" },
    "/supplier": { label: "RFQ pembekal", description: "RFQ, sebut harga dan dokumen yang ditugaskan" },
    ...
    "/products": { label: "Kedai", description: "Produk dan imej untuk pelanggan" },
    "/requests": { label: "Permintaan" }, "/approvals": { label: "Kelulusan" },
    "/budgets": { label: "Bajet", description: "Lejar kebenaran, tempoh dan rizab" },
    "/sourcing": { label: "Penyumberan" }, "/deliveries": { label: "Penghantaran" },
    ...
    "/suppliers": { label: "Pembekal", description: "Organisasi pembekal persendirian" },
    "/users": { label: "Orang & akses", description: "Jemputan, peranan dan skop" },
    "/documents": { label: "Dokumen", description: "Bukti dan rekod yang dibenarkan" },
  ...
  quickActions: { newRequest: "Permintaan baharu", addCompany: "Tambah syarikat", openSourcing: "Buka penyumberan", catalog: "Katalog" },
  shell: {
