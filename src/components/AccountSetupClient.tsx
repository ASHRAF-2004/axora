...
const setupCopy = {
  en: {
    ...
    errors: { password_mismatch: "The passwords do not match. Enter the same password in both fields.", invalid_link: "This setup link is invalid, expired, or has already been used.", password_policy: "Use 15–128 Unicode characters. Your password is never truncated.", save_failed: "Axora could not save your password. Your link was not used; please try again." },
  },
  ar: {
