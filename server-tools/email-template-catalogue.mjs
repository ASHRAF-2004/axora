...
export const EMAIL_TEMPLATE_CATALOGUE = Object.freeze({
  ...
  "delivery-agent-accepted": t("delivery-agent-accepted", "axora-delivery", "Delivery Agent accepted the assignment", "قبل مسؤول التوصيل المهمة", "Penghantar menerima tugasan"),
