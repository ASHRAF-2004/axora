...
| Scene quality | Strong depth, restrained visual mood and purposeful lighting. | Route-specific key/fill/rim lighting, floor shadows, particles and appearance-token colours. |
...
| Materials | Materials reinforce the selected visual mode. | Source materials remain recognizable while lights, floor and transition fragments inherit the active Light/Dark appearance. |
...
| Appearance transitions | Appearance changes affect the full composition. | Light and Dark update centralized tokens, scene lighting and interface surfaces without changing geometry or workflow state. |
| Sound | Optional cues reinforce interactions. | Eight distinct stage cues plus appearance-change, van engine and door cues; muted by default and self-hosted. |
...
| Creative richness | Multiple coordinated sensory systems. | Six page-specific scene sequences, stage-specific models/sounds, Light/Dark appearance, a 3D brand emblem and semantic operational transitions. |
