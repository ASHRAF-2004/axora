...
| Platform-owner MFA or phishing-resistant step-up | **BLOCKED** | Not implemented. `SECURITY_BASELINE.md` records this as a high risk requiring implementation or an explicitly approved rollout mitigation before broad production use. |
