...
- **Verified** now: clean working tree, `feature/coherent-product-refactor` pushed at `a5de307` (tracking `origin/feature/coherent-product-refactor`), PR #30 open/ready, checks passed in run `30761726103`.
