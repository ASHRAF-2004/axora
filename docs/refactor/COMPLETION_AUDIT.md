...
- **Verified** now: clean working tree, `feature/coherent-product-refactor` pushed at `ed7839b` (tracking `origin/feature/coherent-product-refactor`), PR #30 open/ready, checks passed in run `30766613068`.
