...
- **Verified** now: clean working tree, `feature/coherent-product-refactor` pushed at `4732c74` (tracking `origin/feature/coherent-product-refactor`), PR #30 open/ready, checks passed in run `30766344242`.
